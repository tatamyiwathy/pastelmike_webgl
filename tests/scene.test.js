...
describe('Scene', () => {
  ...
  test('ObjGroupのdisposeが子のdisposeを呼ぶ', () => {
  ...
  test('SceneのupdateFrameが各子のupdateFrameを呼ぶ', () => {
